...
SELECT 
    ...
    ISNULL(E.Telefono1, 'Descoñecido') AS Telefono1, ISNULL(E.Telefono2, 'Descoñecido') AS Telefono2,
    D.NomeDepartamento,
...
INNER JOIN PROXECTO P ON E.Localidade = P.Lugar
LEFT JOIN EMPREGADO_PROXECTO EP ON E.NSS = EP.NSSEmpregado
WHERE EP.NumProxecto IS NULL AND (40 - ISNULL(EP.Horas, 0)) > 10;