--1.-   Haz una consulta que muestre la calle, número, planta, puerta, número de habitaciones de los pisos 
de los propietarios que su letra del DNI sea A, B o H. Además también se visualizará junto a la anterior información, un comentario que dependerá del número de habitaciones. Si el número de habitaciones es 1 0 2 se visualizará 'Ideal Parejas sin o con 1 hijo', si tiene 3: 'Ideal Parejas con dos hijos' y si tiene más de tres: 'Ideal Parejas con más de dos hijos'
