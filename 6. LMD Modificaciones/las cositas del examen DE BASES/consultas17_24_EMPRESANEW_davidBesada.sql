...
SELECT COUNT(*) AS 'Número de empregados', SUM(SALARIO) AS 'Suma dos salarios', AVG(SALARIO) AS 'Media dos salarios'
FROM EMPREGADOFIXO

-- 18._ Fai unha consulta que devolva o número de empregados fixos que ten cada departamento e a media dos salarios.

SELECT NomeDepartamento, COUNT(*) AS 'Número de empregados', CAST(AVG(SALARIO) AS DECIMAL(8,2)) AS 'Media dos salarios'
...
SELECT COUNT(*) AS 'Número de nados tras 1969'
FROM EMPREGADO 
